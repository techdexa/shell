...
RUN apt-get -qq install -y --no-install-recommends curl git fuse p7zip mc lynx w3m gnupg2 rclone cowsay tree tar nano unzip wget pv jq build-essential zlib1g-dev libncurses5-dev libgdbm-dev libnss3-dev libssl-dev libsqlite3-dev libreadline-dev libffi-dev openssh-client john fcrackzip tmate libbz2-dev
# add mkvtoolnix
